package com.colombus.clan.messaging.kafka.publisher;
...
public class DomainEventPublisher {
    ...
    public void publishClanMembership(Object payload, String key, long timeoutMs) throws Exception {
        send(topics.getClanMembershipCurrentV1(), key, payload, timeoutMs);
    }
